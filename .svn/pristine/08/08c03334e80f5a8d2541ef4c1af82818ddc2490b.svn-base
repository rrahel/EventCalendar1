...
<!-- 											<small><i class="fa fa-clock-o"></i> 5 mins</small> -->
			...
			<li class="dropdown messages-menu">
				...
				<li class="dropdown user user-menu">
					...
					data-toggle="dropdown"> <!-- The user image in the navbar--> <img
						...
						onerror="if (this.src != 'defaultUser.jpg') this.src = 'defaultUser.jpg';"  alt="User Image" /> <!-- hidden-xs hides the username on small devices so only the image appears. -->
		...
		<div class="user-panel">
			<div class="pull-left image">
				<img src="${pageContext.request.contextPath}/profilImage" class="img-circle"
					onerror="if (this.src != 'defaultUser.jpg') this.src = 'defaultUser.jpg';"   alt="User Image" />
			</div>
		...
		<div class="content-wrapper">
			...
			<h1>
				...
				<small><c:out value='${event.title}'/></small>
			</h1>
			...
			<div class="container" role="main">
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						...
						action="<c:url value="/acceptEvent?${_csrf.parameterName}=${_csrf.token }"/>">
							<fieldset>
								<br> <br>
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<input class="form-control" id="inputTitle" type="text"
											...
											name="title" readonly value="<c:out value="${event.title}"/>">
									</div>
								</div>
								<! ----------------  description ---------------- -->
								<div class="form-group">
									...
									<div class="col-md-10">
										<textarea class="form-control" id="inputDescription"
											type="text" name="description" readonly style="resize: none"><c:out
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<input id="inputMembers" name="members" readonly class="form-control" required value="<c:out value='${event.userGroup.name}'/>">
									...
									<div class="col-md-10">
										<input class="form-control" id="inputLocation" type="text"
											required="true" title="Required field!" name="location"
											 readonly value="<c:out value='${event.location}'/>">
									</div>
								</div>
								<! ----------------  start ---------------- -->
								<div class="form-group">
										...
										<c:choose>
											<c:when test="${event.allDay}">
												<input class="checkbox" id="inputAllDay" type="checkbox"
													checked="checked" name="allDay" disabled readonly value="true">
											</c:when>
											<c:otherwise>
												<input class="checkbox" id="inputAllDay" type="checkbox"
													name="allDay" disabled readonly value="true">
											</c:otherwise>
										</c:choose>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-md-10 col-md-offset-2">
										<button type="submit" name="submitButton" value="accept"
											class="btn btn-success">Accept</button>
										
											<button type="submit" name="submitButton" value="decline"
