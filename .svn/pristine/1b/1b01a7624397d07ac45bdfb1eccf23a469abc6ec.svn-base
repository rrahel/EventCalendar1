	...
	<div class="wrapper">
		...
		<!--  add or edit?  ----------------------------------------------------------- -->
			<c:choose>
				...
				<c:otherwise>
					<c:set var="legend">List of Groups</c:set>
...
<!-- 											<small><i class="fa fa-clock-o"></i> 5 mins</small> -->
		...
		<ul class="sidebar-menu">
			...
			<li class ="active"><a href=<c:url value='listGroups'/>><i class='fa fa-th'></i>
					...
					<!--  list all employees ----------------------------------------------------------- -->
						<c:forEach items="${groups}" var="gp">
							<tr>
								...
								<td>
									<a href="editGroup?id=${gp.groupID}">
